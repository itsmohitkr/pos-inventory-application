...
INSERT INTO "new_Product" ("barcode", "batchTrackingEnabled", "category", "createdAt", "deletedAt", "id", "isDeleted", "lowStockThreshold", "lowStockWarningEnabled", "name", "updatedAt") SELECT "barcode", "batchTrackingEnabled", "category", "createdAt", "deletedAt", "id", "isDeleted", "lowStockThreshold", "lowStockWarningEnabled", "name", "updatedAt" FROM "Product";
DROP TABLE "Product";
