...
const addPayment = async (req, res) => {
    try {
        ...
        return sendSuccessResponse(res, StatusCodes.CREATED, payment, 'Expense payment added successfully', {
            format: 'raw'
        });
    } catch (error) {
        return mapExpenseError(error);
...
const updatePayment = async (req, res) => {
    try {
        ...
        return sendSuccessResponse(res, StatusCodes.OK, payment, 'Expense payment updated successfully', {
            format: 'raw'
        });
    } catch (error) {
        return mapExpenseError(error);
