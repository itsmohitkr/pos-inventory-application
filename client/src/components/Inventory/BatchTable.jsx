      ...
      <Table size="small" aria-label="purchases">
        ...
        <TableBody>
          {batches.map((batch) => {
            ...
            const discount =
              batch.mrp > 0 ? (((batch.mrp - batch.sellingPrice) / batch.mrp) * 100).toFixed(1) : 0;

            return (
              <TableRow key={batch.id}>
                <TableCell component="th" scope="row">
                  <ShortBatchCode batchCode={batch.batchCode} />
                </TableCell>
                ...
                <TableCell align="center">
                  <Box
                    sx={{
                      color:
                        margin > 20 ? 'success.main' : margin > 10 ? 'warning.main' : 'error.main',
                      fontWeight: 'bold',
                    }}
                  >
                    {margin}%
