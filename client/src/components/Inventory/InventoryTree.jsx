          ...
          {currentCategoryProducts.length === 0 ? (
            ...
            <Grid container spacing={2}>
              {currentCategoryProducts.map((product) => {
                ...
                const margin =
                  maxSelling > 0 ? (((maxSelling - maxCost) / maxSelling) * 100).toFixed(1) : 0;
                const maxDiscount =
                  maxMrp > 0 ? (((maxMrp - maxSelling) / maxMrp) * 100).toFixed(1) : 0;
                          ...
                          <Stack spacing={0.5} sx={{ fontSize: '13px' }}>
                            ...
                            >
                              ...
                              >
                                ...
                                <Typography
                                  variant="body2"
                                  sx={{ fontWeight: 700, color: '#1f8a5b' }}
                                >
                                  {margin}%
                                </Typography>
                              </Box>
