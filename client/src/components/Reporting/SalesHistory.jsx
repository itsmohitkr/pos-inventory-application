          ...
          <Table stickyHeader sx={{ minWidth: 1000, tableLayout: "fixed" }}>
            <SortableTableHead
              columns={[
                ...
                { id: 'cost', label: 'COST', align: 'right', sx: { width: '10%' }, getter: (sale) => (sale.netTotalAmount || 0) - (sale.profit || 0) },
                { id: 'netTotalAmount', label: 'AMOUNT', align: 'right', sx: { width: '10%' } },
                { id: 'profit', label: 'PROFIT', align: 'right', sx: { width: '10%' } },
                { id: 'margin', label: 'MARGIN', align: 'center', sx: { width: '8%' }, getter: (sale) => sale.netTotalAmount > 0 ? (sale.profit / sale.netTotalAmount) * 100 : 0 },
                { id: 'status', label: 'STATUS', align: 'center', sx: { width: '13%' }, getter: (sale) => getStatusDisplay(getRefundStatus(sale.items)).label },
                { id: 'actions', label: 'ACTIONS', align: 'center', sx: { width: '13%' }, sortable: false, className: 'no-print' }
              ]}
