    ...
    >
        ...
        >
          ...
          >
            ...
            <Box sx={{ p: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Button
                ...
                startIcon={
                  <CalendarIcon sx={{ color: activeTab === 'sales' ? '#0b1d39' : '#94a3b8' }} />
                }
              >
                Scheduled Sales
              </Button>
          ...
          >
            {activeTab === 'threshold' && (
              ...
              <Paper
                elevation={0}
                sx={{ p: 4, borderRadius: 2, border: '1px solid rgba(0,0,0,0.06)' }}
              >
                    ...
                    <FormControlLabel
                      ...
                      label={
                        <Typography sx={{ fontWeight: 600 }}>
                          Enable Threshold Promotions
                        </Typography>
                      }
                    />
                    <Typography variant="body2" color="text.secondary">
                      Customers receive a free product when their order total meets the thresholds
                            ...
                            <TableRow key={config.threshold} hover>
                              ...
                              <TableCell>
                                <Autocomplete
                                  ...
                                  onChange={(e, newValue) =>
                                    handleUpdateConfig(config.threshold, 'allowedGroups', newValue)
                                  }
                                  renderInput={(params) => (
                                    <TextField
                                      {...params}
      ...
      >
        ...
        <DialogActions sx={{ p: 3, borderTop: '1px solid #f0f0f0', mt: 3 }}>
          <Button onClick={handleCloseDialog} sx={{ color: '#64748b', fontWeight: 600, px: 3 }}>
            Cancel
          </Button>
          <Button
            variant="contained"
