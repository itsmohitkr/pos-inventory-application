            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                ...
                <FormControl fullWidth size="small" sx={{ mt: 1 }}>
                  ...
                  <Select
                    value={
                      printers?.some((p) => p.name === receiptSettings.printerType)
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 2, mt: 1 }}>
                    <TextField
                      ...
                      onChange={(e) =>
                        onTextSettingChange('marginTop', parseInt(e.target.value) || 0)
                      }
                    ...
                    <TextField
                      ...
                      onChange={(e) =>
                        onTextSettingChange('marginBottom', parseInt(e.target.value) || 0)
                      }
                      InputProps={{ inputProps: { min: 0, max: 20 } }}
                    />
                    <TextField
                      ...
                      onChange={(e) =>
                        onTextSettingChange('marginSide', parseInt(e.target.value) || 0)
                      }
                      InputProps={{ inputProps: { min: 0, max: 20 } }}
                    />
                  </Box>
