  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        mrp: parseFloat(String(stockData.mrp)) || 0,
        cost_price: parseFloat(String(stockData.cost_price)) || 0,
        selling_price: parseFloat(String(stockData.selling_price)) || 0,
        wholesaleEnabled: stockData.wholesaleEnabled,
        wholesalePrice: stockData.wholesaleEnabled ? parseFloat(String(stockData.wholesalePrice)) || 0 : null,
