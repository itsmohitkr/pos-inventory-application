  ...
  return (
    <>
              ...
              {isAveragingEnabled && addQty && newCostPrice && (
                <Box sx={{ textAlign: 'right' }}>
                  ...
                  <Typography variant="h6" sx={{ color: 'success.main', fontWeight: 700 }}>
                    ₹
                    {(
                      (currentQty * Number(batch?.costPrice || 0) +
                        displayAddQty * Number(newCostPrice)) /
                      (currentQty + displayAddQty)
                    ).toFixed(2)}
                  </Typography>
                </Box>
              )}
      ...
      <SuccessNotification
        ...
        severity={notification.severity as import('@mui/material').AlertColor}
